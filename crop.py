...
def photo_with_watermark(input_image_path, output_image_path, watermark_image_path, position):
...
cv2.imwrite(f"{image_name}-out.jpg", cv2.cvtColor(newImage, cv2.COLOR_BGR2RGB))

photo_with_watermark(f"{image_name}-out.jpg", f'{image_name}-watermarked.jpg',
						watermark_photo, position=(0,0))
